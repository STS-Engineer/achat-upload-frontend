    ...
    <div className="p-8 space-y-16">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 ">
          {fournisseursList.map((f: Fournisseur) => (
            <div
              key={f.id}
            ...
            <form className="space-y-6" onSubmit={handleAddFournisseur}>
                <div>
                    ...
                    <Input
                        ...
                        onChange={(e) => setFormFournisseur({...formFournisseur, name: e.target.value})}
                        name="name"
                    />
                </div>
                <div>
                ...
                <Alert
                    title={toast}
                    message=""
                    variant={ toast === "fournisseur already registered" ? "error" : "success" }
                />
                )}
            </form>
            </Panel>
